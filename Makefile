...
IMPORT_PATH := github.com/Azure-Samples/openhack-team-cli
DOCKER_IMAGE := openhack-team-cli
exec := $(DOCKER_IMAGE)
github_repo := Azure-Samples/openhack-team-cli
binary := oh
...
VERSION_FLAGS    := -ldflags='-X "github.com/Azure-Samples/openhack-team-cli/version.Version=$(VERSION)" -X "github.com/Azure-Samples/openhack-team-cli/version.BuildTime=$(DATE)"'
